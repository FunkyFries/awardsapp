...
const DisplayAwards: NextPage<{
  ...
  // try {
  const threeRstudents = students.filter(student => student.threeR !== "none");
  ...
  const ARhonorsRows = teachers.map(teacher => {
    let ARbyTeacher = ARstudents.filter(student => student.teacher === teacher);
  ...
  const ABhonorsRows = intermediateTeachers.map(teacher => {
    let ABbyTeacher = ABstudents.filter(student => student.teacher === teacher);
    let rows = [];
  ...
  return (
    <>
      ...
      <Table>
        <thead>
          <tr>
            <th colSpan={5}>Terrific Kid Award</th>
          </tr>
          <tr>
            <th>Teacher</th>
      ...
      <Table>
        <thead>
          <tr>
            <th colSpan={5}>Straight A Honors Award</th>
          </tr>
          <tr>
      ...
      <Table>
        <thead>
          <tr>
            <th colSpan={5}>A/B Honors Award</th>
          </tr>
          <tr>
            <th colSpan={1}>Teacher</th>
            <th colSpan={4}>Recipients</th>
